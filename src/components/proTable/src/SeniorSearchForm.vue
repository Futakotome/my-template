<template>
  <div>
    <ProForm ref="generateDialogForm" :data="searchForm" :remote="remoteFuncs" :entity.sync="entity" />
    <div style="float: left;margin-right: 15px">
      <el-button size="small" type="primary" icon="el-icon-search" @click="getSearchFormData()">查询</el-button>
      <el-button size="small" style="margin-right: 10px" icon="el-icon-refresh" @click="clearEvent()">清空</el-button>
    </div>
  </div>
  ...
  <!--      <el-button type="primary" size="small" class="tool-btn" icon="el-icon-s-help" @click="visible = true">高级查询-->
  <!--      </el-button>-->
  <!--    </el-tooltip>-->
  <!--  </el-popover>-->
</template>
