<template>
  <div class="ProTable">
    ...
    <!-- 表格主体 -->
    <el-table v-loading.lock="loading" v-bind="$attrs" v-on="tableListeners" :height="tableHeight"
              :max-height="maxHeight" ref="tableRefs" :row-key="rowKey" :data="tableData">
      ...
      <el-table-column v-if="isMultiple" type="selection" reserve-selection align="center" header-align="center"
                       width="55" :selectable="selectableFunc"></el-table-column>
      <el-table-column v-if="showColumnIndex" type="index" align="center" label="#" header-align="center"
...
import SearchForm from "@/component/proTable/src/SearchForm.vue";
...
import Column from "@/component/proTable/src/Column";
...
Vue.component(VueCompositionApi);
