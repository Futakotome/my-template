...
const mutations = {
  ...
  DEL_OTHERS_VISITED_VIEWS: (state, view) => {
    state.visitedViews = state.visitedViews.filter(value => {
      return value.meta.affix || value.path === view.path
    })
  },
  ...
  DEL_ALL_VISITED_VIEWS: (state) => {
    state.visitedViews = state.visitedViews.filter(value => value.meta.affix);
  },
